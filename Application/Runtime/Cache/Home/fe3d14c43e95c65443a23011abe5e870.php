  ...
  <!-- Create Customer -->
        <div id="create-customer">
          ...
          <div class="boxed-form">
            <form method="post" action="/Login/LoginHandler" id="create_customer" accept-charset="UTF-8" onsubmit="return LoginHandler()">

              <div id="email" class="clearfix form-row">
                <label for="email" class="login">邮箱</label>
                <input type="email" name="email" id="email" class="styled-input" placeholder="" value="" size="30">
              </div>
