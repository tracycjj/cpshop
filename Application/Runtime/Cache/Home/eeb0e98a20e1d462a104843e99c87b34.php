...
<div id="content" role="main">
  ...
  <div id="collection-list" class="grid-uniform product-list">
	...
	<?php if(is_array($cateSon)): foreach($cateSon as $key=>$cs): ?><div class="grid-item large--col-4 medium-down--col-6">
	  <div class="coll-image-wrap" style="height: 326px;">
	    <a href="/Index/shopCate?cid=<?php echo ($cs["id"]); ?>&<?php echo md5($cs.id);?>">
	        <img src="<?php echo ($cs["picimg"]); ?>" alt="<?php echo ($cs["name"]); ?>">
	    </a>
	  </div><!-- .coll-image-wrap -->
	  <div class="coll-prod-caption">
	    <div class="coll-prod-meta no-medallion">
	      <h4><a href="/Index/shopCate?cid=<?php echo ($sc["id"]); ?>&<?php echo md5($sc.id);?>"><?php echo ($cs["name"]); ?></a></h4>
	      <p class="collection-list-product-count accent-text"><?php echo ($cs["goodsCount"]); ?> products</p>
	    </div><!-- .coll-prod-meta -->
	  </div><!-- .prod-prod-meta -->
