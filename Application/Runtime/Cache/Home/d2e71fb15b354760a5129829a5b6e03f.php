...
<div id="content" role="main">
      <li style="height:490px;width:884px;list-style:none;"><a href='http://www.cpshop.com/index.php/Admin/AdsManager/adsList.html?cid=1'><img style="width:100%;height:100%;" src='/Uploads/Ads/2016-11-25/5837f36a7fb9e.jpg' alt="1231231" /></a></li>
<hr>
...
<div class="grid">
    <div class="grid-item col-12 medium-down--col-12">
          <div class="index-featured-grid">
            <div class="clearfix">
              <h3 class="large--left widget-title"><?php echo ($cate["name"]); ?></h3>
              <a class="large--right accent-text" href="/Index/shopCate?cid=<?php echo ($cate["id"]); ?>&<?php echo md5($cate.id);?>">View all Collections →</a>
            </div>
              <div class="grid-uniform" id="browse-by-category">
      					<?php if(is_array($showCate)): foreach($showCate as $key=>$sc): ?><div class="grid-item large--col-3 medium-down--col-6">
      					  <div class="coll-image-wrap">
      					    <a href="/Index/shopCate?cid=<?php echo ($sc["id"]); ?>&<?php echo md5($sc.id);?>">
      					        <img src="<?php echo ($sc["picimg"]); ?>" alt="Wooden toys and Playmat">
      					    </a>
      					  </div><!-- .coll-image-wrap -->
      					  <div class="coll-prod-caption">
      					    <div class="coll-prod-meta no-medallion">
      					      <h4><a href="/Index/shopCate?cid=<?php echo ($sc["id"]); ?>&<?php echo md5($sc.id);?>"><?php echo ($sc["name"]); ?></a></h4>
      					      <p class="collection-list-product-count accent-text"><?php echo ($sc["goodsCount"]); ?> products</p>
      					    </div><!-- .coll-prod-meta -->
      					  </div><!-- .prod-prod-meta -->
          ...
          <div id="welcome-text">
            <h4 class="widget-title" id="fp-welcome-title">Home of New Zealand's much loved icon, Buzzy Bee</h4>
            <div class="rte">
              <span>Welcome to the online home of all things Buzzy Bee! &nbsp;Our goal is to showcase the best available products featuring the <em>Buzzy Bee, Mary Lou</em> and <em>Buzzy Bee &amp; friends</em> characters. &nbsp;</span><span>This store is proudly owned and run in New Zealand by the official guardians of the Buzzy Bee brand. &nbsp;We ship worldwide.</span>
            </div>
          </div><!-- #welcome-text -->
