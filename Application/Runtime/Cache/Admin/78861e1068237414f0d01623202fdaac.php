                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-cog fa-fw" style="color:orange;"></i> 属性列表</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                       <i class="glyphicon glyphicon-plus" style="color:orange;"></i> 添加属性
                                    </div>
                                    <form action="<?php echo U('addAttrHandler');?>" method="post" onclick="return check()">
                                    <div class="panel-body">
                                        <div class="col-lg-4">
                                ...
                                <?php if(!empty($list)): ?><div class="panel panel-default">
                                    <div class="panel-heading">
                                       <i class="glyphicon glyphicon-pencil"></i> 已添加属性
                                    </div>
                                    <div class="panel-body">
