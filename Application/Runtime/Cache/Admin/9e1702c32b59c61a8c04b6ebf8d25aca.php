...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<div class="search">
							<form action="<?php echo U('artList');?>" method='get'>
								<select name="cid">
									<option value='0'>请选择分类</option>
									<?php if(is_array($artCatelist)): foreach($artCatelist as $key=>$cate): ?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["name"]); ?></option><?php endforeach; endif; ?>
								</select>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                           	...
                                           	<td><?php echo (mysubstr($vo['profile'],'0','80')); ?></td>

                                            <td>
												<a class="btn btn-sm btn btn-primary" href="<?php echo U('Article/editArt','id='.$vo['id']);?>">编辑</a>
    ...
    <script type="text/javascript">
       ...
       function del(id){
        	$.get("<?php echo U('Article/delArt');?>",{"id":id},function(e){
        		window.location.href=window.location.href;
        	})
        }
    </script>
