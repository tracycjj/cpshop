                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading" style="height:50px;">
                           <h3 style="width:50%;float:left;" class="panel-title"><i class="glyphicon glyphicon-star-empty" style="color:orange;"></i> 添加文章</h3> 
                        ...
                        <div class="panel-body">
                            <div class="col-lg-6" style="width:90%;">
                                <form action="<?php echo U('Article/addArtHanlder');?>" method="post" enctype="multipart/form-data" onsubmit="return check()">
									...
									<div class="form-group" style="width:45%;" >
                                        ...
                                        <select class="form-control" name="cid">
											<?php if(is_array($artCatelist)): foreach($artCatelist as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
									<div class="form-group" style="width:45%;">
	                                        <label>列表图片:</label>
                                   ...
                                   <div class="form-group" id="type" style="border:1xp solid red;height:350px;">
                                        ...
                                        <div style="height:450px;width:80%;">
                                             <textarea name="profile" id="editor-profile" type="text/plain" style="width:100%;height:200px;"></textarea>                                          
                                        </div>
                                    </div>
