                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-plus" style="color:orange;"></i> 添加广告</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('AdsManager/addAdsHandler');?>" method="post" onsubmit="return check()" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>广告名称(<font color="red">*必填</font>)</label>
                                        <input class="form-control" type="text" value="<?php echo ($ads["token"]); ?>" name="name">
									...
									<div class="form-group" >
                                        ...
                                        <select class="form-control" name="cid">
											<?php if(is_array($adsCate)): foreach($adsCate as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
