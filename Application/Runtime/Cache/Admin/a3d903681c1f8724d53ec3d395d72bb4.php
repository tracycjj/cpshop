                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('Article/artCateAddHandler', 'id='.$id);?>" method="post" onsubmit="return check()" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>分类名称</label>
                                        <input class="form-control" type="text" value="<?php echo ($wxConfig["token"]); ?>" name="name">
                                    ...
                                    <div class="form-group" id="type" style="margin-top:00px;">
                                        ...
                                        <input class="form-control" type="radio" value="1" name="show" checked="checked" /><span>是</span>
                                        <input class="form-control" type="radio" value="0" name="show" <?php if($gamemess['ishot'] == 1): ?>checked="checked"<?php endif; ?> /><span>否</span>
                                        </div>
                                    </div>
