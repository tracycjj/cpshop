                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading" style="height:50px;">
                           <h3 style="width:50%;float:left;" class="panel-title"><i class="glyphicon glyphicon-star-empty" style="color:orange;"></i> 商品列表</h3> 
                        	<div class="text-right" style="width:40%;float:right;"><a class="btn btn-info" href="<?php echo U('ShopGoods/addGoods');?>">添加商品</a></div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:5px">分类ID</th>
                                            <th style="width:100px">商品名</th>
                                            <th style="width:20px">现价</th>
                                            <th style="width:20px">原价</th>
                                            <th style="width:20px">库存</th>
                                            <th style="width:20px">销量</th>
                                            <th style="width:20px">属性管理</th>
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                           	...
                                           	<td><?php echo ($vo["pricenow"]); ?></td>
                                            <td><?php echo ($vo["priceold"]); ?></td>
                                            <td><?php echo ($vo["stocks"]); ?></td>
                                            <td><?php echo ($vo["sales"]); ?></td>
                                           
                                            <td><?php if($vo['goodsattr']): ?><a class="btn btn-sm btn-info" href="<?php echo U('ShopGoods/goodsAttr','id='.$vo['id']);?>">管理</a>
                                            	<?php else: ?>未开启<?php endif; ?>
                                            </td>
                                            <td>
												<?php if($vo['xiajia'] == 1): ?><a class="btn btn-sm btn btn-danger" href="javascript:void(0);" onclick="xiajia(<?php echo ($vo['id']); ?>,0)" ><i class="glyphicon glyphicon-arrow-down"></i>下架</a>
												<?php else: ?>
													<a class="btn btn-sm btn btn-success" href="javascript:void(0);" onclick="xiajia(<?php echo ($vo['id']); ?>,1)" ><i class="glyphicon glyphicon-arrow-up"></i>上架</a><?php endif; ?>
												<a class="btn btn-sm btn btn-primary" href="<?php echo U('ShopGoods/editGoods','id='.$vo['id']);?>">编辑</a>
