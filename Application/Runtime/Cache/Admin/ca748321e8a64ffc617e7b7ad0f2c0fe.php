                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-edit" style="color:orange;"></i> 编辑分类[<?php echo ($cate["name"]); ?>]</h3>
                            <div class="text-right"><a class="btn btn-info" href="<?php echo U('index');?>">返回</a></div>

                        </div>
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('ShopCate/editCateHanlder', 'id='.$id);?>" method="post" onsubmit="return check()" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>分类名称</label>
                                        <input class="form-control" type="text" value="<?php echo ($cate["name"]); ?>" name="name">
                                        <input class="form-control" type="hidden" value="<?php echo ($cate["id"]); ?>" name="id">
									...
									<div class="form-group" >
                                        ...
                                        <select class="form-control" name="pid">
											...
											<?php if(is_array($cateList)): foreach($cateList as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $cate['pid']): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
                                    <div class="form-group" style="margin-left:0px;width:100%">
                                        <label>备注</label><br/>
                                        <input class="form-control" type="text" value="<?php echo ($cate["note"]); ?>" name="note">
                                        <p class="help-block"></p>
                                    </div>
                                    <div class="form-group">
                                            <label>展示图片</label>
                                            <input class="form-control" type="file" value="<?php echo ($cate["picimg"]); ?>" name="picimg"/>
                                            <p class="help-block"></p>
                                    </div>
