                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-cog fa-fw"></i> 配置权限节点列表</h3>
                                <div class="text-right"><a href="<?php echo U('editApp');?>">配置应用</a></div>
                            </div>
                            <form action="<?php echo U('listAllHandler');?>" method="post">
                            <div class="panel-body">
                                ...
                                <?php else: ?>
                                没有添加任何权限，请<a href="<?php echo U('editApp');?>">添加权限节点名称</a>。<?php endif; ?>
                            </div>
                            </form>
                        </div>
                    </div>
