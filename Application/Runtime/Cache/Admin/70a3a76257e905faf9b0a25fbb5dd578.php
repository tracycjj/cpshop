...
<style type="text/css">
    ...
    .menu1 .form-group{float:left;border:0px solid red;height:60px;width:45%;margin-right: 5%;}
	.menu2 .form-group{float:left;border:0px solid red;height:60px;width:45%;margin-right: 5%;}
	</style>
</head>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-edit fa-fw"></i> 商城设置</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('editShopSetHandler', 'id='.$id);?>" method="post" onsubmit="return true">
                                    <div class="form-group">
                                        <label>域名</label>
                                        <input class="form-control" type="text" value="<?php echo ($list["shopurl"]); ?>" name="shopurl">
                                    ...
                                    <div class="form-group">
										...
										<label class="radio-inline">
											<input   type="radio" name="isyou" value="1" <?php if($list['isyou'] == 1): ?>checked="checked"<?php endif; ?> >开启
										</label>
										<label class="radio-inline">
											<input  type="radio" name="isyou" value="0" checked="checked" <?php if($list['isyou'] == 0): ?>checked="checked"<?php endif; ?> >免邮
										</label>
                                        <p class="help-block"></p>
                                    </div>
                                     <div class="menu1">
                                        <div class="form-group">
                                            <label>全场定邮(元)</label>
                                            <input class="form-control" type="text" value="<?php echo ($list["postage"]); ?>" name="postage">
                                            <p class="help-block"></p>
                                        </div>
                                         <div class="form-group">
                                            <label>包邮价格(元)</label>
                                            <input class="form-control" type="text" value="<?php echo ($list["freepostage"]); ?>" name="freepostage"/>
                                            <p class="help-block"></p>
                                        </div> 
