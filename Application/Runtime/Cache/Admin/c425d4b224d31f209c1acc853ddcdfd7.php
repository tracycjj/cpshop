                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-lg-6" style="width:90%;">
                                <form action="<?php echo U('ShopGoods/addGoodsHanlder');?>" method="post" enctype="multipart/form-data" onsubmit="return check()">
									...
									<div class="menu1">
                                        <div class="form-group">
                                            <label>现价(元)</label>
                                            <input class="form-control" type="text" value="" name="pricenow">
                                            <p class="help-block"></p>
                                        </div>
                                         <div class="form-group">
                                            <label>原价(元)</label>
                                            <input class="form-control" type="text" value="" name="priceold"/>
                                            <p class="help-block"></p>
                                        </div> 
                                        <div style="clear: both"></div>
                                    </div>
                                    ...
                                    <div class="menu1">
	                                    <div class="form-group" style="width:20%;">
	                                        <label>库存</label>
	                                        <input class="form-control" type="text" value="10000" name="stocks">
	                                        <p class="help-block"></p>
	                                    </div>
	                                    <div class="form-group" style="width:20%;">
	                                        <label>自定义销量</label>
	                                        <input class="form-control" type="text" value="" name="sales">
	                                        <p class="help-block">默认为0,未开启,前端不显示</p>
	                                    </div>
	                                    <div style="clear: both"></div> 
	                                 </div>
                                     <div class="form-group" id="type" style="margin-top:30px;">
                                        <label>开启属性</label>
                                        <div style="height:30px;width:100%;">
                                        <input class="form-control" type="radio" value="0" name="goodsattr" checked="checked" /><span>关闭</span>
                                        <input class="form-control" type="radio" value="1" name="goodsattr"/><span>开启</span>
                                        </div>
                                    </div>
                                    <div class="form-group" id="type" style="margin-top:30px;">
                                        <label>商品标签</label>
                                        <div style="height:30px;width:100%;">
                                        <?php if(is_array($tagList)): foreach($tagList as $key=>$tl): ?><input class="form-control" type="checkbox" value="<?php echo ($tl["id"]); ?>" name="tagid[]"/><span><?php echo ($tl["name"]); ?></span><?php endforeach; endif; ?>
                                        </div>
                                    </div>
                                    <div class="menu2" style="margin:30px 0px;">
                                        <div class="form-group">
                                            <label>一级分销(%)</label>
                                            <input class="form-control" type="text" value="" name="fx[]">
                                   ...
                                   <div class="form-group" id="type" style="border:1xp solid red;height:500px;">
                                        ...
                                        <div style="height:450px;width:80%;">
                                             <textarea name="profile" id="editor-application1" type="text/plain" style="width:100%;height:350px;"></textarea>                                          
                                        </div>
                                    </div>
                                    <div class="form-group" id="type" style="border:1xp solid red;height:600px;">
                                        <label>产品介绍</label>
                                        <div style="height:450px;width:80%;">
                                             <textarea name="content" id="editor-application" type="text/plain" style="width:100%;height:450px;"></textarea>                                          
                                        </div>
                                    </div>
