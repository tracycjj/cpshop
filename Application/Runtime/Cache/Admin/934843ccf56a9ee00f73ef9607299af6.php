...
<style type="text/css">table tr,td,th{text-align: center;}#catename{background:#C5E1E4;margin-top:5px;display:block;width:100px;height:30px;border-radius:5px;text-align:center;line-height:30px;color:orange;}</style>
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="glyphicon glyphicon-sort-by-attributes" style="color:orange;"></i> 分类列表</h3>
                            </div>
...
<!--                                                 <td><?php echo ($vo[""]); ?></td>
                                                 -->
                                                <td>
													<a class="btn btn-sm btn btn-primary" href="<?php echo U('ShopCate/editCate','id='.$vo['id']);?>">编辑</a>
    ...
    <script type="text/javascript">
        ...
        function del(id){
        	if(confirm("该栏目如果存在子栏目，请先删除子栏目,确认删除？")){
        		window.location.href="/Admin/ShopCate/delCate/id/"+id;
        	}
        }
    </script>
