...
<body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo ($hello); ?> <small>今天是2015年10月14日</small><small dynamic-time></small></h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo ($ordercount["todayorder"]); ?></div>
                                <div>今日订单</div>
                            </div>
                        </div>
                    </div>
                    <a href="<?php echo U('Order/index');?>">
                        <div class="panel-footer">
                            <span class="pull-left">今日订单</span>
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo ($ordercount["zongorder"]); ?></div>
                                <div>总订单</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo ($ordercount["yclorder"]); ?></div>
                                <div>已处理订单</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo ($ordercount["wclorder"]); ?></div>
                                <div>未处理订单</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
                        <div class="panel-footer">
                            <span class="pull-left">未处理订单</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            <div class="clearfix"></div>
                        </div>
                    </a>
    ...
    <script src="/Public/sb-admin/bower_components/morrisjs/morris.min.js"></script>
    <script src="/Public/sb-admin/js/morris-data.js"></script>
    ...
    <script type="text/javascript">
        $(function() {
            //会员、司机活跃次数统计图
            LoginTimesLineChart("<?php echo U('Ajax/memberChart');?>");
            //javascript时间动态显示
            DynamicTime('hh:mm:ss');
            //加载用户名
