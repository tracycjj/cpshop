...
.table>tbody>tr>td{line-height:50px;text-align:center;}</style>
<style type="text/css">table tr,td,th{text-align: center;}#catename{background:#C5E1E4;margin-top:5px;display:block;width:200px;height:30px;border-radius:5px;text-align:center;line-height:30px;color:orange;}</style>
<body>
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="glyphicon glyphicon-sort-by-attributes" style="color:orange;"></i> 文章分类列表<a href="<?php echo U('Article/artCateAdd');?>" class="btn btn-success" style="float:right;margin-top:-8px;color:white;">添加分类</a></h3>
                            </div>
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                ...
                                                <td style="text-align:left;">
                                                    <span id="catename" style="margin-left:<?php echo ($vo['level']*40-40); ?>px;"><?php echo ($vo["name"]); ?></span></td>
                                                <td><?php echo ($vo["tag"]); ?></td>                                                   
                                                <td><?php if($vo['type'] == 1): ?>单页<?php else: ?>列表<?php endif; ?></td>                                                   
                                                <td><?php if($vo['show'] == 1): ?>显示<?php else: ?>不显示<?php endif; ?></td>                                                   

                                                <td style="text-align:left;"><img src="<?php echo ($vo["picimg"]); ?>" style="max-height:50px;width:auto;text-align:center;"></td>
                                                <td>
													<a class="btn btn-sm btn btn-primary" href="<?php echo U('Article/editArtCate','id='.$vo['id']);?>">编辑</a>
    ...
    <script type="text/javascript">
        ...
        function del(id){
        	if(confirm("该栏目如果存在子栏目，请先删除子栏目,确认删除？")){
        		window.location.href="/Admin/Article/delArtCate/id/"+id;
        	}
        }
    </script>
