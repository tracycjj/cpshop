...
<body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="panel panel-default">
                                    ...
                                    <form action="<?php echo U('addAdsCateHandler');?>" method="post" onclick="return check()">
                                    <div class="panel-body">
                                        <div class="col-lg-4">
                                            ...
                                            <table class="table table-bordered table-hover table-striped" style="width:60%;">
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                        <td>
                                                            <input class="form-control" style="width:;" type="text" data-id="<?php echo ($vo["id"]); ?>" name="adsname" value="<?php echo ($vo["name"]); ?>">
                                                        </td>
                                                         <td>
                                                            <input class="form-control" type="text" data-id="<?php echo ($vo["id"]); ?>" name="adstag" value="<?php echo ($vo["tag"]); ?>"><br/>
                                                            
                                                        </td>
                                                        <td>
                                                        	<a class="btn btn-sm btn-primary" href="javascript:;">保存</a>
                                                            <a class="btn btn-sm btn-primary" href="<?php echo U('delAdsCate', 'id='.$vo['id']);?>">删除</a>
                                                        </td>
    ...
    <script type="text/javascript">
        $(function () {
            var adsname=$("input[name='adsname']");
            var adstag=$("input[name='adstag']");
            adsname.blur(function(){
                var id=$(this).data("id");
                var name=$(this).val();
                $.post("<?php echo U('AdsManager/editAdsCate');?>",{"id":id,"name":name},function(e){
                     console.log(e.info);
                    if(e.status == 1){
            ...
            adstag.blur(function(){
                var id=$(this).data("id");
                var tag=$(this).val();
                $.post("<?php echo U('AdsManager/editAdsCate');?>",{"id":id,"tag":tag},function(e){
                    console.log(e.info); 
                    if(e.status == 1){
