                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-cog fa-fw" style="color:orange;"></i> 标签列表</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                       <i class="glyphicon glyphicon-plus" style="color:orange;"></i> 添加标签
                                    </div>
                                    <form action="<?php echo U('addShopTag');?>" method="post" onclick="return check()">
                                    <div class="panel-body">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>字体显示色(#e4e4e4)</label>
                                                <input class="form-control"  placeholder="默认：#e4e4e4" type="text" name="color">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                ...
                                <?php if(!empty($list)): ?><div class="panel panel-default">
                                    <div class="panel-heading">
                                       <i class="glyphicon glyphicon-pencil"></i> 已添加标签
                                    </div>
                                    <div class="panel-body">
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-sm btn-primary" href="<?php echo U('delShopTag', 'id='.$vo['id']);?>">删除</a>
                                                        </td>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            nameEdit.blur(function(){
                var id=$(this).data("id");
                var name=$(this).val();
                $.post("<?php echo U('ShopTag/save');?>",{"id":id,"name":name},function(e){
                     console.log(e.info);
                    if(e.status == 1){
            ...
            colorEdit.blur(function(){
                var id=$(this).data("id");
                var color=$(this).val();
                $.post("<?php echo U('ShopTag/save');?>",{"id":id,"color":color},function(e){
                    console.log(e.info); 
                    if(e.status == 1){
