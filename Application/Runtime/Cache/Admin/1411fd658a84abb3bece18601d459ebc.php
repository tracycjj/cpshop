                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-th-list fa-fw"></i> 角色列表</h3>
                            <div class="text-right"><a href="<?php echo U('Role/add');?>">添加角色</a></div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($items)): foreach($items as $key=>$vo): ?><tr>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" href="<?php echo U('edit','id='.$vo['id']);?>">编辑</a></td>
                                            <td><a class="btn btn-sm btn-primary" href="<?php echo U('access', 'id='.$vo['id']);?>">配置</a></td>
                                            <td><a class="btn btn-sm btn-primary" href="<?php echo U('delete');?>">删除</a></td>
