                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-plus fa-fw"></i> 添加角色</h3>
                            <div class="text-right"><a href="<?php echo U('Role/listAll');?>">角色列表</a></div>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('addHandler');?>" method="post">
