                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-plus" style="color:orange;"></i> 添加分类</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <form action="<?php echo U('ShopCate/addCateHanlder', 'id='.$id);?>" method="post" onsubmit="return check()" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="margin-left:0px;width:100%">
                                        <label>备注</label><br/>
                                        <input class="form-control" type="text" value="<?php echo ($wxConfig["token"]); ?>" name="note">
                                        <p class="help-block"></p>
                                    </div>
                                    <div class="form-group">
                                            <label>展示图片</label>
