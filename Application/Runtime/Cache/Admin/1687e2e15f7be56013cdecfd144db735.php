                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-edit fa-fw"></i> 修改角色</h3>
                            ...
                            <div class="col-lg-6">
                                <form action="<?php echo U('editHandler', 'id='.$id);?>" method="post">
                                    <div class="form-group">
                                        <label>名称</label>
                                        <input class="form-control" type="text" value="<?php echo ($item["name"]); ?>" name="name">
                                        <p class="help-block">角色名称，英文或数字。</p>
                                    </div>
                                    <div class="form-group">
                                        <label>描述</label>
                                        <input class="form-control" type="text" value="<?php echo ($item["remark"]); ?>" name="remark">
                                        <p class="help-block">角色描述，中文备注名称。</p>
                                    </div>
                                    <div class="form-group">
                                        <label>角色状态</label>
